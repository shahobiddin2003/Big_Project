...
let ProductsCardBox = document.querySelector("#products_cards");
// console.log(ProductsCardBox);
let showProductsCards = products.map((el, i) => {
  return `
...
ProductsCardBox.innerHTML = showProductsCards;
